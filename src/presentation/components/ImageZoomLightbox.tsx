  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/12 bg-[#0a0807]/90 p-2 shadow-[0_32px_120px_-20px_rgba(0,0,0,0.85)] ring-1 ring-denuded-gold/10 sm:p-3">
          <img
            src={src}
            alt={alt}
