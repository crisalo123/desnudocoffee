        ...
        <main>
          <section className="relative overflow-hidden border-b border-white/10">
            <div
              ...
              aria-hidden
            >
              <div className="absolute left-1/2 top-0 h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-amber-600/10 blur-3xl" />
              <div className="absolute -right-20 bottom-0 h-80 w-80 rounded-full bg-rose-900/15 blur-3xl" />
            </div>
